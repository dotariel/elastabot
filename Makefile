...
LDFLAGS=-ldflags=all="-X github.com/dotariel/elestabot/app.Version=$(PROJECT_BUILD_VERSION) -X github.com/dotariel/elestabot/app.BuildDate=$(PROJECT_BUILD_DATE)"
